...
export const siteConfig: SiteConfig = {
	...
	description: "雾创岛是初春网络旗下专注于优质资源聚合的分享平台，涵盖 PC 软件、安卓应用、实用 APP、各类源码及多领域精品资源，致力于通过精选内容与流畅体验，打造国内用户体验一流的综合性资源分享网站。",
	...
	links: [
		{
			...
			url: "https://www.cv0.cn",
		},
		{
			name: "QQ",
			icon: "fa6-brands:qq",
			url: "https://qm.qq.com/q/lzT9IDkKVG",
		},
		{
			name: "BiliBili",
